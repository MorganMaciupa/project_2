...
var layers = {
  RENEWABLES: new L.LayerGroup(),
  NON_RENEWABLES: new L.LayerGroup(),
};
...
var map = L.map("map-id", {
  ...
  layers: [
    lightmap,
    layers.RENEWABLES,
    layers.NON_RENEWABLES,
  ]
});

// Create an overlays object to add to the layer control
var overlays = {
  "Renewable Energy Plants": layers.RENEWABLES,
  "Non-Renewable Energy Plants": layers.NON_RENEWABLES,
};
